...
*/
  ...
  public static function setCurrency($currency="USD",$price=0){
      //
      $req_url = 'https://v6.exchangerate-api.com/v6/8bb50329cc0a093212b8e360/latest/USD';
      ...
      if(false !== $response_json) {
          ...
          if('success' === $response->result) {
            ...
            $price = round(($base_price * $response->conversion_rates->$currency), 2);
