...
<table style="background:#FFFF; border:#000000 1px solid;" width="622" cellspacing="0" cellpadding="0" border="0"
       align="center">
    <tbody>
    <tr class="first">
        <td>
                    ...
                    <td width="622">
                        <table style="margin-top:20px;" width="580" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <tr style="color:#fff;  ">
                                ...
                                <td width="50">&nbsp;</td>
                                <td width="251" align="right">Order date : {{ date('Y-F-d H:i:s a',strtotime($data->created_at))}}</td>
                            </tr>
                            <tr style="color:#fff">

                                <td width="25">&nbsp;</td>
                                <td style="font-size:15px;" id="total_sum" width="30" align="right">${{number_format($subtotalt, 2, '.', '')}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
