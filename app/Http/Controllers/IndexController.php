...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        $recommendProduct = Helper::getImageWithData('products','id','',"is_active=1 and is_recommend=1",0,'order by id asc');
        ...
        ->with('homeMenu',true)->with(compact('banner','category','popuplarProduct','trailProduct','recommendProduct','ProductCategory'));
    ...
    public function product($slug='')
    {
        ...
        return view('product')->with('title','Product Listing')->with('productmenu',true)->with(compact('product','category','program_support','language_support','slug'));
    }
