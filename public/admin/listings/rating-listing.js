const tablename='rating';const ydebugger=false; var ytabled;
...
(async () => {
    ...
    */
    // var TYPEDATA = await getAjaxTable('product','id','name','is_deleted=0 and is_active=1');
    ...
    [
         ...
         { "left join" : "(select id as product_id,name as product_name from products) as product on  rating.product_id=product.product_id" } ,
    ],
    [
        'editFast',
        'viewFast',
